...
class ChochVisualizer:
    ...
    def save_plot(self, filename: str = None, output_dir: str = None,
        ...
        if filename is None:
            ...
            filename = f"choch_analysis_{self.symbol}_{timeframe}{date_range}_{timestamp}.html"
...
def main():
    ...
    parser = argparse.ArgumentParser(description='CHoCH Detector Visualization Test')
    ...
    parser.add_argument('--base-strength', type=int, default=5,
                       help='CHoCH base strength parameter (default: 5)')
    ...
    try:
        ...
        visualizer = ChochVisualizer(args.symbol)
